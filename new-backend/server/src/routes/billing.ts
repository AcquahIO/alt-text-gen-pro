...
router.post('/api/create-checkout-session', requireAuth, async (req: AuthenticatedRequest, res) => {
...
router.post('/api/create-portal-session', requireAuth, async (req: AuthenticatedRequest, res) => {
